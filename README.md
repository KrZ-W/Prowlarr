...
> **🍁 KrZ-W fork.** This is a personal fork that adds a configurable indexer cooldown
> schedule and a Docker/GHCR deployment. See **[FORK.md](FORK.md)** for the feature list
> and versioning, **[docs/](docs/)** for the reference, and **[CHANGELOG.md](CHANGELOG.md)**
